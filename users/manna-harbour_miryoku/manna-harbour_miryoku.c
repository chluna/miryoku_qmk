...
const key_override_t comma_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_COMM, KC_COLN);
const key_override_t dot_key_override   = ko_make_basic(MOD_MASK_SHIFT, KC_DOT,  KC_SCLN);
